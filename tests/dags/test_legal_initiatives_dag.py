...
from sem_covid.entrypoints.etl_dags.legal_initiatives import DAG_NAME, get_single_item, make_request
from tests.unit.test_store.fake_storage import FakeObjectStore


def test_legal_initiatives_has_two_tasks_and_order(airflow_dag_bag):
...
def transformer_legal_initiatives(a):
    return a
...
def test_get_single_item():
    ...
    response = get_single_item(query, json_file_name, FakeSPARQL(), FakeObjectStore(), transformer_legal_initiatives)
