...
from sem_covid.entrypoints.etl_dags.legal_initiatives_worker import DAG_NAME


def test_legal_initiatives_worker_has_three_tasks_and_order(airflow_dag_bag):
