...
DAG_NAME = dag_name(category="etl", name="eu_cellar_covid", role="worker", version_major=0, version_minor=11)
...
class EuCellarDagWorker(DagPipeline):
    ...
    def extract_content_with_tika(self, *args, **context):
    ...
    def download_file(self, source: dict, location_details: str, file_name: str, minio):
        try:
    ...
    def content_cleanup(self, *args, **context):
        ...
        if "content" in json_document and json_document["content"]:
            json_document["content"] = self.content_cleanup_tool(json_document["content"])
    ...
    def content_cleanup_tool(self, text: str) -> str:
        """
