...
crawl_dag_pipeline = CrawlDagPipeline(config.IRELAND_TIMELINE_JSON, config.IRELAND_TIMELINE_BUCKET_NAME,
                                      config.IRELAND_TIMELINE_ELASTIC_SEARCH_INDEX_NAME, CONTENT_PATH_KEY,
                                      IrishGovCrawler)
