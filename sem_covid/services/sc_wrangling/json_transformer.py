...
EU_CELLAR_REFACTORING_RULES = '''.| {
    ...
    title: (.title // empty) | (if . == "" or . == [] then empty else (.| tostring | split("| ") ) end),
    cdm_types: (.cdm_types // empty) | (if . == "" or . == [] then empty else (.| tostring | split("| ") ) end),
    cdm_type_labels: (.cdm_type_labels // empty) | (if . == "" or . == [] then empty else (.| tostring | split("| ") ) end),
    resource_types: (.resource_types // empty) | (if . == "" or . == [] then empty else (.| tostring | split("| ") ) end),
    resource_type_labels: (.resource_type_labels // empty) | (if . == "" or . == [] then empty else (.| tostring | split("| ") ) end),
    eurovoc_concepts: (.eurovoc_concepts // empty) | (if . == "" or . == [] then empty else (.| tostring | split("| ") ) end),
    eurovoc_concept_labels: (.eurovoc_concept_labels // empty) | (if . == "" or . == [] then empty else (.| tostring | split("| ") ) end),
    subject_matters: (.subject_matters // empty) | (if . == "" or . == [] then empty else (.| tostring | split("| ") ) end),
    subject_matter_labels: (.subject_matter_labels // empty) | (if . == "" or . == [] then empty else (.| tostring | split("| ") ) end),
    directory_codes: (.directory_codes // empty) | (if . == "" or . == [] then empty else (.| tostring | split("| ") ) end),
    directory_codes_labels: (.directory_codes_labels // empty) | (if . == "" or . == [] then empty else (.| tostring | split("| ") ) end),
    celex_numbers: (.celex_numbers // empty) | (if . == "" or . == [] then empty else (.| tostring | split("| ") ) end),
    legal_elis: (.legal_elis // empty) | (if . == "" or . == [] then empty else (.| tostring | split("| ") ) end),
    id_documents: (.id_documents // empty) | (if . == "" or . == [] then empty else (.| tostring | split("| ") ) end),
    same_as_uris: (.same_as_uris // empty) | (if . == "" or . == [] then empty else (.| tostring | split("| ") ) end),
    authors: (.authors // empty) | (if . == "" or . == [] then empty else (.| tostring | split("| ") ) end),
    author_labels: (.author_labels // empty) | (if . == "" or . == [] then empty else (.| tostring | split("| ") ) end),
    full_ojs: (.full_ojs // empty) | (if . == "" or . == [] then empty else (.| tostring | split("| ") ) end),
    oj_sectors: (.oj_sectors // empty) | (if . == "" or . == [] then empty else (.| tostring | split("| ") ) end),
    internal_comments: (.internal_comments // empty) | (if . == "" or . == [] then empty else (.| tostring | split("| ") ) end),
    is_in_force: (.is_in_force // empty) | (if . == "" or . == [] then empty else (.| tostring | split("| ") ) end),
    dates_document: (.dates_document // empty) | (if . == "" or . == [] then empty else (.| tostring | split("| ") ) end),
    dates_created: (.dates_created // empty) | (if . == "" or . == [] then empty else (.| tostring | split("| ") ) end),
    legal_dates_entry_into_force: (.legal_dates_entry_into_force // empty) | (if . == "" or . == [] then empty else (.| tostring | split("| ") ) end),
    legal_dates_signature: (.legal_dates_signature // empty) | (if . == "" or . == [] then empty else (.| tostring | split("| ") ) end),
    manifs_pdf: (.manifs_pdf // empty) | (if . == "" or . == [] then empty else (.| tostring | split("| ") ) end),
    manifs_html: (.manifs_html // empty) | (if . == "" or . == [] then empty else (.| tostring | split("| ") ) end),
    pdfs_to_download: (.pdfs_to_download // empty) | (if . == "" or . == [] then empty else (.| tostring | split("| ") ) end),
    htmls_to_download: (.htmls_to_download // empty) | (if . == "" or . == [] then empty else (.| tostring | split("| ") ) end),
    dossiers: (.dossiers // empty) | (if . == "" or . == [] then empty else (.| tostring | split("| ") ) end),
    related_works: (.related_works // empty) | (if . == "" or . == [] then empty else (.| tostring | split("| ") ) end),
    work_sequences: (.work_sequences // empty) | (if . == "" or . == [] then empty else (.| tostring | split("| ") ) end) 
}'''
