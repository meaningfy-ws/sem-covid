...
def clean_remove_numbers(text : str, replace_with : str = "<NUMBER>")->str:
    return clean(text, fix_unicode=False, to_ascii=False, lower=False, no_numbers=True,replace_with_number=replace_with)
...
def clean_remove_currency_symbols(text : str, replace_with : str = "<CUR>")->str:
    return clean(text, fix_unicode=False, to_ascii=False, lower=False, no_currency_symbols=True,replace_with_currency_symbol=replace_with)
